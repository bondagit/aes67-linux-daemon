...
* patch to enable the configuration of smaller ALSA buffer sizes to reduce end-to-end latency to up to 8ms (from driver version v1.4). See [platform latency test](#latency)
